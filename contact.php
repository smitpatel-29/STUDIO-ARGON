...
<section class="page-hero">
  <div class="page-hero-bg" style="background-image:url('<?php echo !empty($hero['image_url']) ? $hero['image_url'] : 'https://images.unsplash.com/photo-1519643381401-22c77e60520e?auto=format&fit=crop&q=80&w=2070'; ?>')"></div>
  ...
  <div class="container">
    <div class="contact-grid">
      ...
      <div class="contact-form-col">
        ...
        <h2 class="section-title">Request a <span class="highlight-red">Quote</span></h2>
      ...
      <!-- INFO -->
      <?php $info = get_page_content('contact', 'info'); ?>
      <div class="contact-info-col">
        <span class="section-label">DIRECTIONS</span>
        <h2 class="section-title"><?php echo $info['heading']; ?></h2>
        ...
        <div class="contact-info-item">
          ...
          <div><h4>Email</h4><p><?php echo SITE_EMAIL; ?></p></div>
        </div>
        <div class="contact-info-item">
          <div class="contact-info-icon">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l2.27-2.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"></path></svg>
          </div>
          <div><h4>Phone</h4><p><?php echo SITE_PHONE; ?></p></div>
        </div>
      </div>
